...
quantity_allocation_disagreement <-
  ...
  # save initial reference and comparison to use for residual error calculation
  # and then reclassify the original reference and comparison to binary values
  # for other classifications as we are only concerned with locational accuracy
  # of infection not exact population predictions (residual error is a
  # comparison of exact population numbers)
  comp <- comparison
  ref <- reference
  ...
  output <-
    data.frame(quantity_disagreement = 0,
