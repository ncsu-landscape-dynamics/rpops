...
configuration <- function(config) {
  ...
  suitable <- terra::classify(suitable, matrix(c(-Inf, 0, NA), ncol = 3, 
  ...
  config$spatial_indices <- lapply(seq_along(suitable_row), function(i) {
    c(suitable_row[i], suitable_col[i])})
