...
static int _PoPS_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        signatures.insert("List(*pops_model_cpp)(int,bool,double,int,IntegerMatrix,std::vector<IntegerMatrix>,IntegerMatrix,IntegerMatrix,bool,IntegerMatrix,IntegerMatrix,IntegerMatrix,std::vector<NumericMatrix>,std::vector<std::string>,std::vector<int>,IntegerMatrix,bool,std::vector<std::vector<int>>,std::vector<std::string>,bool,std::vector<NumericMatrix>,std::vector<NumericMatrix>,double,double,int,int,std::string,double,std::vector<std::vector<int>>,double,int,int,int,std::string,std::string,std::string,std::string,std::string,bool,double,double,double,std::string,double,std::string,double,std::string,int,std::string,int,bool,std::string,int,bool,std::string,int,bool,bool,bool,bool,double,double,bool,Nullable<List>)");
    }
