...
// pops_model
List pops_model(int random_seed, bool use_lethal_temperature, double lethal_temperature, int lethal_temperature_month, IntegerMatrix infected, IntegerMatrix susceptible, IntegerMatrix total_plants, bool mortality_on, IntegerMatrix mortality_tracker, IntegerMatrix mortality, std::vector<NumericMatrix> treatment_maps, std::vector<std::string> treatment_dates, IntegerMatrix resistant, bool weather, std::vector<NumericMatrix> temperature, std::vector<NumericMatrix> weather_coefficient, double ew_res, double ns_res, int num_rows, int num_cols, std::string time_step, double reproductive_rate, double mortality_rate, int mortality_time_lag, int season_month_start, int season_month_end, double start_time, double end_time, int treatment_month, std::string treatment_method, std::string natural_kernel_type, std::string anthropogenic_kernel_type, bool use_anthropogenic_kernel, double percent_natural_dispersal, double natural_distance_scale, double anthropogenic_distance_scale, std::string natural_dir, double natural_kappa, std::string anthropogenic_dir, double anthropogenic_kappa, int pesticide_duration, int num_days);
static SEXP _PoPS_pops_model_try(SEXP random_seedSEXP, SEXP use_lethal_temperatureSEXP, SEXP lethal_temperatureSEXP, SEXP lethal_temperature_monthSEXP, SEXP infectedSEXP, SEXP susceptibleSEXP, SEXP total_plantsSEXP, SEXP mortality_onSEXP, SEXP mortality_trackerSEXP, SEXP mortalitySEXP, SEXP treatment_mapsSEXP, SEXP treatment_datesSEXP, SEXP resistantSEXP, SEXP weatherSEXP, SEXP temperatureSEXP, SEXP weather_coefficientSEXP, SEXP ew_resSEXP, SEXP ns_resSEXP, SEXP num_rowsSEXP, SEXP num_colsSEXP, SEXP time_stepSEXP, SEXP reproductive_rateSEXP, SEXP mortality_rateSEXP, SEXP mortality_time_lagSEXP, SEXP season_month_startSEXP, SEXP season_month_endSEXP, SEXP start_timeSEXP, SEXP end_timeSEXP, SEXP treatment_monthSEXP, SEXP treatment_methodSEXP, SEXP natural_kernel_typeSEXP, SEXP anthropogenic_kernel_typeSEXP, SEXP use_anthropogenic_kernelSEXP, SEXP percent_natural_dispersalSEXP, SEXP natural_distance_scaleSEXP, SEXP anthropogenic_distance_scaleSEXP, SEXP natural_dirSEXP, SEXP natural_kappaSEXP, SEXP anthropogenic_dirSEXP, SEXP anthropogenic_kappaSEXP, SEXP pesticide_durationSEXP, SEXP num_daysSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _PoPS_pops_model(SEXP random_seedSEXP, SEXP use_lethal_temperatureSEXP, SEXP lethal_temperatureSEXP, SEXP lethal_temperature_monthSEXP, SEXP infectedSEXP, SEXP susceptibleSEXP, SEXP total_plantsSEXP, SEXP mortality_onSEXP, SEXP mortality_trackerSEXP, SEXP mortalitySEXP, SEXP treatment_mapsSEXP, SEXP treatment_datesSEXP, SEXP resistantSEXP, SEXP weatherSEXP, SEXP temperatureSEXP, SEXP weather_coefficientSEXP, SEXP ew_resSEXP, SEXP ns_resSEXP, SEXP num_rowsSEXP, SEXP num_colsSEXP, SEXP time_stepSEXP, SEXP reproductive_rateSEXP, SEXP mortality_rateSEXP, SEXP mortality_time_lagSEXP, SEXP season_month_startSEXP, SEXP season_month_endSEXP, SEXP start_timeSEXP, SEXP end_timeSEXP, SEXP treatment_monthSEXP, SEXP treatment_methodSEXP, SEXP natural_kernel_typeSEXP, SEXP anthropogenic_kernel_typeSEXP, SEXP use_anthropogenic_kernelSEXP, SEXP percent_natural_dispersalSEXP, SEXP natural_distance_scaleSEXP, SEXP anthropogenic_distance_scaleSEXP, SEXP natural_dirSEXP, SEXP natural_kappaSEXP, SEXP anthropogenic_dirSEXP, SEXP anthropogenic_kappaSEXP, SEXP pesticide_durationSEXP, SEXP num_daysSEXP) {
    SEXP rcpp_result_gen;
    {
        ...
        rcpp_result_gen = PROTECT(_PoPS_pops_model_try(random_seedSEXP, use_lethal_temperatureSEXP, lethal_temperatureSEXP, lethal_temperature_monthSEXP, infectedSEXP, susceptibleSEXP, total_plantsSEXP, mortality_onSEXP, mortality_trackerSEXP, mortalitySEXP, treatment_mapsSEXP, treatment_datesSEXP, resistantSEXP, weatherSEXP, temperatureSEXP, weather_coefficientSEXP, ew_resSEXP, ns_resSEXP, num_rowsSEXP, num_colsSEXP, time_stepSEXP, reproductive_rateSEXP, mortality_rateSEXP, mortality_time_lagSEXP, season_month_startSEXP, season_month_endSEXP, start_timeSEXP, end_timeSEXP, treatment_monthSEXP, treatment_methodSEXP, natural_kernel_typeSEXP, anthropogenic_kernel_typeSEXP, use_anthropogenic_kernelSEXP, percent_natural_dispersalSEXP, natural_distance_scaleSEXP, anthropogenic_distance_scaleSEXP, natural_dirSEXP, natural_kappaSEXP, anthropogenic_dirSEXP, anthropogenic_kappaSEXP, pesticide_durationSEXP, num_daysSEXP));
    }
...
static int _PoPS_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        signatures.insert("List(*pops_model)(int,bool,double,int,IntegerMatrix,IntegerMatrix,IntegerMatrix,bool,IntegerMatrix,IntegerMatrix,std::vector<NumericMatrix>,std::vector<std::string>,IntegerMatrix,bool,std::vector<NumericMatrix>,std::vector<NumericMatrix>,double,double,int,int,std::string,double,double,int,int,int,double,double,int,std::string,std::string,std::string,bool,double,double,double,std::string,double,std::string,double,int,int)");
    }
...
static const R_CallMethodDef CallEntries[] = {
    {"_PoPS_pops_model", (DL_FUNC) &_PoPS_pops_model, 42},
