...
static int _PoPS_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        signatures.insert("List(*pops_model)(int,bool,double,int,IntegerMatrix,IntegerMatrix,IntegerMatrix,bool,IntegerMatrix,IntegerMatrix,std::vector<NumericMatrix>,std::vector<std::string>,std::vector<int>,IntegerMatrix,bool,std::vector<NumericMatrix>,std::vector<NumericMatrix>,double,double,int,int,std::string,double,double,int,int,int,std::string,std::string,std::string,std::string,std::string,bool,double,double,double,std::string,double,std::string,double,std::string)");
    }
