...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type use_behavior_module(use_behavior_moduleSEXP);
    Rcpp::traits::input_parameter< Nullable<IntegerMatrix> >::type grower_id_raster(grower_id_rasterSEXP);
    Rcpp::traits::input_parameter< Nullable<IntegerMatrix> >::type grower_type_raster(grower_type_rasterSEXP);
    Rcpp::traits::input_parameter< Nullable<List> >::type behavior_params_list(behavior_params_listSEXP);
    Rcpp::traits::input_parameter< std::vector<std::string> >::type behavior_decision_dates(behavior_decision_datesSEXP);
    Rcpp::traits::input_parameter< int >::type behavior_pesticide_duration(behavior_pesticide_durationSEXP);
    rcpp_result_gen = Rcpp::wrap(pops_model_cpp(random_seed, multiple_random_seeds, random_seeds, lethal_temperature, lethal_temperature_month, host_pools, total_populations, competency_table, pest_host_table, quarantine_areas, quarantine_directions, treatment_maps, treatment_dates, pesticide_duration, movements, movements_dates, temperature, survival_rates, weather_coefficient, weather_coefficient_sd, bbox, res, rows_cols, soil_reservoirs, reproductive_rate, spatial_indices, season_month_start_end, frequency_config, bool_config, start_date, end_date, treatment_method, natural_kernel_type, anthropogenic_kernel_type, percent_natural_dispersal, natural_distance_scale, anthropogenic_distance_scale, natural_dir, natural_kappa, anthropogenic_dir, anthropogenic_kappa, frequencies_n_config, model_type_, latency_period, establishment_probability, dispersal_percentage, survival_rate_month, survival_rate_day, overpopulation_config, network_config, network_data_config, weather_size, weather_type, dispersers_to_soils_percentage, use_behavior_module, grower_id_raster, grower_type_raster, behavior_params_list, behavior_decision_dates, behavior_pesticide_duration));
...
static const R_CallMethodDef CallEntries[] = {
    {"_PoPS_pops_model_cpp", (DL_FUNC) &_PoPS_pops_model_cpp, 60},
