...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(pops_model_cpp(random_seed, use_lethal_temperature, lethal_temperature, lethal_temperature_month, infected, total_exposed, exposed, susceptible, total_populations, total_hosts, mortality_on, mortality_tracker, mortality, quarantine_areas, treatment_maps, treatment_dates, pesticide_duration, resistant, use_movements, movements, movements_dates, weather, temperature, weather_coefficient, bbox, res, rows_cols, time_step, reproductive_rate, spatial_indices, season_month_start_end, mortality_rate, mortality_time_lag, start_date, end_date, treatment_method, natural_kernel_type, anthropogenic_kernel_type, use_anthropogenic_kernel, percent_natural_dispersal, natural_distance_scale, anthropogenic_distance_scale, natural_dir, natural_kappa, anthropogenic_dir, anthropogenic_kappa, frequencies_n_config, output_frequency, quarantine_frequency, use_quarantine, spreadrate_frequency, mortality_frequency, use_spreadrates, model_type_, latency_period, generate_stochasticity, establishment_stochasticity, movement_stochasticity, deterministic, establishment_probability, dispersal_percentage, use_overpopulation_movements, overpopulation_config, network_config, network_data_config));
...
RcppExport SEXP _PoPS_pops_model_cpp(SEXP random_seedSEXP, SEXP use_lethal_temperatureSEXP, SEXP lethal_temperatureSEXP, SEXP lethal_temperature_monthSEXP, SEXP infectedSEXP, SEXP total_exposedSEXP, SEXP exposedSEXP, SEXP susceptibleSEXP, SEXP total_populationsSEXP, SEXP total_hostsSEXP, SEXP mortality_onSEXP, SEXP mortality_trackerSEXP, SEXP mortalitySEXP, SEXP quarantine_areasSEXP, SEXP treatment_mapsSEXP, SEXP treatment_datesSEXP, SEXP pesticide_durationSEXP, SEXP resistantSEXP, SEXP use_movementsSEXP, SEXP movementsSEXP, SEXP movements_datesSEXP, SEXP weatherSEXP, SEXP temperatureSEXP, SEXP weather_coefficientSEXP, SEXP bboxSEXP, SEXP resSEXP, SEXP rows_colsSEXP, SEXP time_stepSEXP, SEXP reproductive_rateSEXP, SEXP spatial_indicesSEXP, SEXP season_month_start_endSEXP, SEXP mortality_rateSEXP, SEXP mortality_time_lagSEXP, SEXP start_dateSEXP, SEXP end_dateSEXP, SEXP treatment_methodSEXP, SEXP natural_kernel_typeSEXP, SEXP anthropogenic_kernel_typeSEXP, SEXP use_anthropogenic_kernelSEXP, SEXP percent_natural_dispersalSEXP, SEXP natural_distance_scaleSEXP, SEXP anthropogenic_distance_scaleSEXP, SEXP natural_dirSEXP, SEXP natural_kappaSEXP, SEXP anthropogenic_dirSEXP, SEXP anthropogenic_kappaSEXP, SEXP frequencies_n_configSEXP, SEXP output_frequencySEXP, SEXP quarantine_frequencySEXP, SEXP use_quarantineSEXP, SEXP spreadrate_frequencySEXP, SEXP mortality_frequencySEXP, SEXP use_spreadratesSEXP, SEXP model_type_SEXP, SEXP latency_periodSEXP, SEXP generate_stochasticitySEXP, SEXP establishment_stochasticitySEXP, SEXP movement_stochasticitySEXP, SEXP deterministicSEXP, SEXP establishment_probabilitySEXP, SEXP dispersal_percentageSEXP, SEXP use_overpopulation_movementsSEXP, SEXP overpopulation_configSEXP, SEXP network_configSEXP, SEXP network_data_configSEXP) {
    SEXP rcpp_result_gen;
    {
        ...
        rcpp_result_gen = PROTECT(_PoPS_pops_model_cpp_try(random_seedSEXP, use_lethal_temperatureSEXP, lethal_temperatureSEXP, lethal_temperature_monthSEXP, infectedSEXP, total_exposedSEXP, exposedSEXP, susceptibleSEXP, total_populationsSEXP, total_hostsSEXP, mortality_onSEXP, mortality_trackerSEXP, mortalitySEXP, quarantine_areasSEXP, treatment_mapsSEXP, treatment_datesSEXP, pesticide_durationSEXP, resistantSEXP, use_movementsSEXP, movementsSEXP, movements_datesSEXP, weatherSEXP, temperatureSEXP, weather_coefficientSEXP, bboxSEXP, resSEXP, rows_colsSEXP, time_stepSEXP, reproductive_rateSEXP, spatial_indicesSEXP, season_month_start_endSEXP, mortality_rateSEXP, mortality_time_lagSEXP, start_dateSEXP, end_dateSEXP, treatment_methodSEXP, natural_kernel_typeSEXP, anthropogenic_kernel_typeSEXP, use_anthropogenic_kernelSEXP, percent_natural_dispersalSEXP, natural_distance_scaleSEXP, anthropogenic_distance_scaleSEXP, natural_dirSEXP, natural_kappaSEXP, anthropogenic_dirSEXP, anthropogenic_kappaSEXP, frequencies_n_configSEXP, output_frequencySEXP, quarantine_frequencySEXP, use_quarantineSEXP, spreadrate_frequencySEXP, mortality_frequencySEXP, use_spreadratesSEXP, model_type_SEXP, latency_periodSEXP, generate_stochasticitySEXP, establishment_stochasticitySEXP, movement_stochasticitySEXP, deterministicSEXP, establishment_probabilitySEXP, dispersal_percentageSEXP, use_overpopulation_movementsSEXP, overpopulation_configSEXP, network_configSEXP, network_data_configSEXP));
    }
...
static int _PoPS_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        signatures.insert("List(*pops_model_cpp)(int,bool,double,int,IntegerMatrix,IntegerMatrix,std::vector<IntegerMatrix>,IntegerMatrix,IntegerMatrix,IntegerMatrix,bool,std::vector<IntegerMatrix>,IntegerMatrix,IntegerMatrix,std::vector<NumericMatrix>,std::vector<std::string>,std::vector<int>,IntegerMatrix,bool,std::vector<std::vector<int>>,std::vector<std::string>,bool,std::vector<NumericMatrix>,std::vector<NumericMatrix>,List,List,List,std::string,double,std::vector<std::vector<int>>,List,double,int,std::string,std::string,std::string,std::string,std::string,bool,double,double,double,std::string,double,std::string,double,Nullable<List>,std::string,std::string,bool,std::string,std::string,bool,std::string,int,bool,bool,bool,bool,double,double,bool,Nullable<List>,Nullable<List>,Nullable<List>)");
    }
