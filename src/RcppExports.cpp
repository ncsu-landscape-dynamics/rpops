...
static int _PoPS_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        signatures.insert("List(*pops_model_cpp)(int,double,int,IntegerMatrix,IntegerMatrix,std::vector<IntegerMatrix>,IntegerMatrix,IntegerMatrix,IntegerMatrix,std::vector<IntegerMatrix>,IntegerMatrix,IntegerMatrix,std::vector<NumericMatrix>,std::vector<std::string>,std::vector<int>,IntegerMatrix,std::vector<std::vector<int>>,std::vector<std::string>,std::vector<NumericMatrix>,std::vector<NumericMatrix>,std::vector<NumericMatrix>,List,List,List,double,std::vector<std::vector<int>>,List,List,List,double,int,std::string,std::string,std::string,std::string,std::string,double,double,double,std::string,double,std::string,double,Nullable<List>,std::string,int,double,double,Nullable<List>,Nullable<List>,Nullable<List>)");
    }
...
static const R_CallMethodDef CallEntries[] = {
    {"_PoPS_pops_model_cpp", (DL_FUNC) &_PoPS_pops_model_cpp, 51},
