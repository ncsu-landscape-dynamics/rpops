...
test_that("Model stops if kernel is of the wrong type and/or dimension", {
  ...
  temperature_file <- system.file("extdata", "simple2x2",
                                  "critical_temp_all_below_threshold.tif",
                                  package = "PoPS")
  start_date <- "2008-01-01"
  end_date <- "2010-12-31"
  parameter_means <- c(0, 21, 1, 500, 0, 0, 0, 0)
...
test_that("Mortality works as expected with multiple ", {
  ...
  expect_equal(data$mortality[[1]], matrix(0, ncol = 20, nrow = 20))
  expect_equal(data$mortality[[2]], matrix(0, ncol = 20, nrow = 20))
  expect_equal(data$mortality[[3]], terra::as.matrix(terra::rast(infected_file), wide = TRUE))
  ...
  expect_equal(data$mortality[[5]], terra::as.matrix(terra::rast(infected_file), wide = TRUE))
  ...
  expect_equal(data$mortality[[7]], terra::as.matrix(terra::rast(infected_file), wide = TRUE))
  ...
  expect_equal(data$mortality[[11]], terra::as.matrix(terra::rast(infected_file), wide = TRUE))
})
...
test_that("uncertainty propogation works as expected", {
  ...
  host_file <- system.file("extdata", "simple20x20", "host_w_sd2.tif", package = "PoPS")
  total_populations_file <-
