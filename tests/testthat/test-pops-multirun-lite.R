context("test-pops-multirun-lite")
...
test_that("Model stops if files don't exist or aren't the correct extension", {
  ...
  expect_error(pops_multirun_lite(infected_file = "",
                    host_file =  host_file,
  ...
  expect_error(pops_multirun_lite(infected_file = infected_file,
                             host_file =  host_file,
                             total_populations_file =  host_file,
                             parameter_means = parameter_means,
                             parameter_cov_matrix = parameter_cov_matrix,
...
test_that("Multirun model outputs work", {
  ...
  data <- pops_multirun_lite(infected_file,
                        host_file,
                        total_populations_file,
                        parameter_means,
